...
import { OrganizationOption, OrganizationSelectorService } from 'shared-features';
import { ClientsStore } from '../../stores/clients/clients.store';
// import { ClientsService } from '../../modules/clients/services/clients/clients.service'; // Disabled - clients module removed
...
export class BackofficeOrganizationSelectorService implements OrganizationSelectorService {
  ...
  // private clientsService = inject(ClientsService); // Disabled - clients module removed
  ...
  loadOrganizations(): void {
    ...
    // Note: ClientsService disabled due to module removal
    ...
    //     .subscribe();
    // }
    console.warn('Organization loading disabled - clients module removed');
  }
}
